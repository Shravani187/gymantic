const slidePage = document.querySelector(".register_content--form--page");
...
const progressStep = document.querySelectorAll(".register_progress--step");
const progressNumber = document.querySelectorAll(
  ".register_progress--step span"
);
...
submitBtn.addEventListener("click", () => {
  tick();
  setTimeout(() => {
    alert("your form is successfully subitted");
    location.reload();
  }, 1000);
});
